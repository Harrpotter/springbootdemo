                ...
                for(var i=0;i<data.length;i++){
                    ...
                    if(data[i].parentid==0){
                        ...
                        for(var j=0;j<data.length;j++){
                            if(data[j].parentid==data[i].periid){
                                console.log(data[j].parentid+""+data[i].periid);
                                lis+=" <dd><a class='site-demo-active' data-url=' "+data[j].urlpath+" ' data-title=' "+data[j].pername+" 'data-id=' "+data[j].periid+" '>"+data[j].pername+"</a></dd>";
                            }
                        }
                        lis+=" </dl>";
                    }
